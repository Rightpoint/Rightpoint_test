...
import type { GetThoughtDetailStaticProps } from './ThoughtDetail.server'
...
export interface ThoughtDetailProps {
    ...
    headerCtaLinkProps?: LinkProps
}
export const ThoughtDetail: NextPage<GetThoughtDetailStaticProps> = ({
    seoProps,
    pageProps,
}) => {
    ...
    return (
        <>
            ...
            <ThoughtHeader
                ...
                renderBelow={() =>
                    headerCtaLinkProps && <Link {...headerCtaLinkProps} />
                }
            />
            <Box
                maxWidth={1170 + 200}
