...
import type { LinkProps } from '@rightpoint/core/components' // careful with a non type import re: circular import
        ...
        if (
            ...
            try {
                return {
                    ...
                    /**
                     * NOTE: This is a blind assumption that pages contain a Title field.
                     *
