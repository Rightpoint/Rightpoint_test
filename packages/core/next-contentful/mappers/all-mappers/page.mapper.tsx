    ...
    implements PageMapperInterface<P>
{
    ...
    public async getProps(): Promise<P> {
        /**
         * Do not catch errors from entryToProps() as it will generate a page and not prevent the build.
         * At the moment a build error is caught, its source should be investigated and better
         * guarded at the source (e.g. in the entryToProps function).
         */
