...
export const AspectSizer: FC<AspectSizerProps> = ({
    ...
    const hasMotionProps = Boolean(motionProps)
    return (
        <s.Sizer
            $aspectRatioPadding={aspectRatioPadding}
            as={hasMotionProps ? motion.div : 'div'}
            /**
 ...
 */
export interface AspectWrappedComponentProps {
...
export const withAspectWrapper = <ComponentToWrapProps extends object>(
    ComponentToWrap: ComponentType<
        ComponentToWrapProps & AspectWrappedComponentProps
    >,
    options?: object
    ...
    const WrappedComponent = ({
        ...
        /**
         * Removed to support CSS var overrides at all times
         */
...
const useResponsiveContextAspectWrapperRatio = (
    ...
    /**
     * @deprecated -- using React to render desktop vs mobile causes a re-render and SSR clash
     * Should find ways to avoid this, such as using CSS vars to change the aspect sizer padding such
     * that the DOM looks the same mobile or not.
     */
