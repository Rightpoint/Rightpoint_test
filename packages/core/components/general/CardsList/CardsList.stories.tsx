...
export const FullWidthList = Template.bind({})
FullWidthList.args = cardsListGenerators.fullWidthList()

export const StandardGrid = Template.bind({})
StandardGrid.args = cardsListGenerators.standardGrid()

export const StandardGridPeople = Template.bind({})
StandardGridPeople.args = cardsListGenerators.standardGridPeople()
