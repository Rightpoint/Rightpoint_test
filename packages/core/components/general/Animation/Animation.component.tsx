...
export const useScrollAnimation: UseAnimationInViewport = ({
    ...
    if (isImage) {
        /**
         * Don't use Parallaxer on mobile
         */
        if (isMobile) {
            return {
                Animation: withAnimationOverride(InViewFadeIn, {
                    animationSet: 'inViewportImage',
                }),
            }
        }
    ...
    if (lessMovement) {
        return { Animation: withAnimationOverride(InViewFadeIn) }
    }

    return { Animation: withAnimationOverride(InViewFadeSlideUp) }
}
