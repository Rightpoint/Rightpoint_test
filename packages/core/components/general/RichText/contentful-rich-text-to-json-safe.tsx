...
/**
 * Convert a Contentful Rich Text Document to a JSON safe,
 * smaller object, with support for custom project specific node handlers (e.g. embedded entries, URL resolvers)
 */
