...
const richTextBaseCss = css`
    ...
    // headings are always direct descendants of rich text and we can prevent
    // cascading styles which will conflict with arbitrarily embeddable components.
    // NOTE: another method is to override contentful rich text renderer and add rich text classes to all nodes.
    > {
        h1,
        h2,
        h3,
