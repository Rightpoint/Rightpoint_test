...
const JobCategory: FC<JobCategoryProps> = ({ category }) => {
    ...
    return (
        <s.Category>
            ...
            {/* 
                This animation is disabled, because it only works in the forward direction which is jarring.
                The problem is that the children disappear instantly on re-filter, before animation complete.            
            */}
