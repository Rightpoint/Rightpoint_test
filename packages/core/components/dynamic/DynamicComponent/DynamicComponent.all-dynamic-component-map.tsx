...
import type { Config } from '@rightpoint/core/next-contentful/configs/config.types'
...
export const dynamicComponents: DynamicComponents = {
    ...
    [DynamicComponentType.SolutionsAnimation]: {
        ...
        lazyGetMapper: () =>
            import(
                './dynamic-components/SolutionsAnimation/SolutionsAnimation.contentful'
            ).then((mod) => mod.SolutionsAnimationMapperConfig),
    },
