...
export const linkMapperNewConfig = makeConfig<LinkEntry, LinkProps>({
    ...
    entryToProps: async ({ entry, manager }) => {
        ...
        return {
            ...
            scrollTo,
            cursorProps: cursorText ? { text: cursorText } : null,
            /**
             * If as button selected, pass text button props to link component.
             */
            asButton: asButton
                ? {
                      text: title,
...
/**
 * DO NOT USE -- DEPRECATED -- OLD LINK MODEL
