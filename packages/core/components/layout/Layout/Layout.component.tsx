...
import { animationSelectors } from '@rightpoint/core/redux'
...
export const LayoutWithNavbar: FC<LayoutProps> = ({ children, debug }) => {
    ...
    /*  
        the navbar can be disabled
        for the homepage which specially injects the navbar below the first component
    */
    const { noNavbar } = useContext(GlobalContext)
    return (
        <>
