...
import { ContainerWidths, getContainerBoxProps } from './container'
...
const ComponentRootWrapper: FC<ComponentRootWrapperProps> = ({
    ...
    const containerBoxProps = getContainerBoxProps(container)
    ...
    return (
        ...
        >
            {/* 
                Set container widths, if provided by a components mapEntryToRootProps
            */}
            <ConditionalWrapper
                condition={!isEmpty(containerBoxProps)}
                wrapper={(children) => (
                    <Box data-container {...containerBoxProps}>
                        {children}
                    </Box>
                )}
            >
