 ...
 */
const isOldSiteRedirectPermanent = true // do not make permanent until certain. Permanents are cached heavily across network layers and devices.
...
const staticRedirects = [
    ...
    },
    {
        source: '/work/browse(/?)',
        destination: '/work/browse/all',
        permanent: true, // these might change
    },
    {
     ...
     */
    {
        source: '/thought/(\\d{1,})/(\\d{1,})/(\\d{1,})/:slug',
    ...
    /**
     * RPLabs redirects
     * Has very high bounce rate and very low interaction.
     */
    {
        source: '/rplabs/:slug*',
        destination: '/thought?rplabs',
        permanent: false,
    },
