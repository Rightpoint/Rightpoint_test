            ...
            },
            {
                ...
                value:
                    process.env.NODE_ENV === 'development'
                        ? "default-src 'self'; \
                            script-src 'self' 'nonce-test123' 'unsafe-eval' blob: http: https: https://cdn.cookielaw.org https://va.vercel-scripts.com https://www.googletagmanager.com https://geolocation.onetrust.com https://td.doubleclick.net https://www.google-analytics.com https://j.6sc.co https://lltrck.com https://snap.licdn.com https://p.teads.tv https://s.yimg.com https://googleads.g.doubleclick.net http://www.google-analytics.com/ga.js https://j.6sc.co/6si.min.js https://js.zi-scripts.com/zi-tag.js; \
                            style-src 'self' 'unsafe-inline' https://vercel.live/fonts; \
                            img-src 'self' data: http: https:; \
                            font-src 'self' 'unsafe-inline' https://cdn.cookielaw.org data:; \
                            connect-src 'self' http: https: https://cdn.cookielaw.org https://va.vercel-scripts.com https://www.googletagmanager.com https://geolocation.onetrust.com https://td.doubleclick.net https://www.google-analytics.com https://t.teads.tv https://cm.teads.tv https://px.ads.linkedin.com https://s.yimg.com https://js.zi-scripts.com/zi-tag.js; \
                            frame-src http: https: https://td.doubleclick.net https://fledge.teads.tv; \
                            object-src 'none'; \
                            frame-ancestors 'none';"
                        : "default-src 'self'; \
                            script-src 'self' 'nonce-test123' blob: http: https: https://cdn.cookielaw.org https://va.vercel-scripts.com https://www.googletagmanager.com https://geolocation.onetrust.com https://td.doubleclick.net https://www.google-analytics.com https://j.6sc.co https://lltrck.com https://snap.licdn.com https://p.teads.tv https://s.yimg.com https://googleads.g.doubleclick.net http://www.google-analytics.com/ga.js https://j.6sc.co/6si.min.js https://js.zi-scripts.com/zi-tag.js; \
                            style-src 'self' 'unsafe-inline' https://vercel.live/fonts; \
                            img-src 'self' data: http: https:; \
                            font-src 'self' 'unsafe-inline' https://cdn.cookielaw.org data:; \
                            connect-src 'self' http: https: https://cdn.cookielaw.org https://va.vercel-scripts.com https://www.googletagmanager.com https://geolocation.onetrust.com https://td.doubleclick.net https://www.google-analytics.com https://t.teads.tv https://cm.teads.tv https://px.ads.linkedin.com https://s.yimg.com https://js.zi-scripts.com/zi-tag.js; \
