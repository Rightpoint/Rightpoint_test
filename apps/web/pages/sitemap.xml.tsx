...
import type { PageMapperConfig } from '@rightpoint/core/next-contentful'
...
export async function getServerSideProps({ res }) {
     ...
     *
     * To do:
     * - Switch to a chained GraphQL query to reduce payload size. Currently at about 40% capacity of API limits (3mb vs 7mb limit)
     */
